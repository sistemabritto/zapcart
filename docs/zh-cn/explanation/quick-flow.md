...
完整的 EVO 方法在编写任何代码之前会生成产品简报、PRD、架构文档和 Epic/Story 分解。Quick Flow 用单个技术规范替代所有这些。这之所以有效，是因为 Quick Flow 针对以下变更：
...
- **Quick Flow**：快速流程。EVO 方法中用于小型变更的简化工作流程，跳过完整的产品规划和架构文档阶段。
