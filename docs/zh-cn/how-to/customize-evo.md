...
:::note[前置条件]
- 在项目中安装了 EVO（参见[如何安装 EVO](./install-evo.md)）
- 用于编辑 YAML 文件的文本编辑器
:::
...
| **Modify EVO Installation** | 用于添加或删除模块的完整安装流程                             |
...
- 运行 `npx evo-method install` 并选择 **Recompile Agents** 以应用更改
...
- 运行 `npx evo-method install` 并选择 **Recompile Agents** 以恢复默认设置

## 工作流自定义

对现有 EVO Method 工作流和技能的自定义即将推出。
