---
title: "如何安装 EVO"
description: 在项目中安装 EVO 的分步指南
sidebar:
  order: 1
---

使用 `npx evo-method install` 命令在项目中设置 EVO，并选择你需要的模块和 AI 工具。
...
安装程序会显示可用的模块。选择你需要的模块——大多数用户只需要 **EVO Method**（软件开发模块）。
...
你也可以向它提问：
```
/evo-help 我刚安装完成，应该先做什么？
/evo-help 对于 SaaS 项目我有哪些选项？
```
...
**安装程序工作正常但后续出现问题**——你的 AI 需要 EVO 上下文才能提供帮助。请参阅[如何获取关于 EVO 的答案](./get-answers-about-evo.md)了解如何将你的 AI 指向正确的来源。
