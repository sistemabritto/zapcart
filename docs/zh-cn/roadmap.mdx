---
title: 路线图
description: EVO 的下一步计划——功能、改进与社区贡献
---

# EVO 方法：公开路线图

EVO 方法、EVO 方法模块（BMM）和 EVO 构建器（BMB）正在持续演进。以下是我们正在开展的工作以及即将推出的内容。
...
<div class="roadmap-container">
  ...
  <div class="roadmap-future">
    ...
    <div class="roadmap-future-card">
      <span class="roadmap-emoji">💎</span>
      <h4>社区模块爆发</h4>
      <p>娱乐、安全、治疗、角色扮演以及更多内容。扩展 EVO 方法平台。</p>
    </div>
    <div class="roadmap-future-card">
      <span class="roadmap-emoji">⚡</span>
      <h4>开发循环自动化</h4>
  ...
  <div class="roadmap-future">
    ...
    <div class="roadmap-future-card">
      <span class="roadmap-emoji">🖥️</span>
      <h4>官方 UI</h4>
      <p>整个 EVO 生态系统的精美界面。CLI 的强大，GUI 的精致。</p>
    </div>
    <div class="roadmap-future-card">
      <span class="roadmap-emoji">🔒</span>
      <h4>EVO 一体机</h4>
  ...
  <div style="text-align: center; margin-top: 3rem; padding: 2rem; background: var(--color-bg-card); border-radius: 12px; border: 1px solid var(--color-border);">
    ...
    <p style="color: var(--slate-color-400); margin: 0;">
      这只是计划内容的一部分。EVO 开源团队欢迎贡献者！{" "}<br />
      <a href="https://github.com/evo-code-org/EVO-METHOD" style="color: var(--color-in-progress);">在 GitHub 上加入我们</a>，共同塑造 AI 驱动开发的未来。
    </p>
    <p style="color: var(--slate-color-400); margin: 1.5rem 0 0;">
      喜欢我们正在构建的东西？我们感谢一次性与月度{" "}<a href="https://buymeacoffee.com/evo" style="color: var(--color-in-progress);">支持</a>。
    </p>
