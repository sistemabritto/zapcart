---
title: Roadmap
description: What's next for EVO - Features, improvements, and community contributions
---

# The EVO Method: Public Roadmap

The EVO Method, EVO Method Module (BMM), and EVO Builder (BMB) are evolving. Here's what we're working on and what's coming next.
...
<div class="roadmap-container">
  ...
  <div class="roadmap-future">
    ...
    <div class="roadmap-future-card">
      ...
      <p>Entertainment, security, therapy, roleplay and much more. Expand the EVO Method platform.</p>
    </div>
    <div class="roadmap-future-card">
      <span class="roadmap-emoji">⚡</span>
  ...
  <div class="roadmap-future">
    ...
    <div class="roadmap-future-card">
      <span class="roadmap-emoji">🖥️</span>
      <h4>Official UI</h4>
      <p>A beautiful interface for the entire EVO ecosystem. CLI power, GUI polish.</p>
    </div>
    <div class="roadmap-future-card">
      <span class="roadmap-emoji">🔒</span>
      <h4>EVO in a Box</h4>
  ...
  <div style="text-align: center; margin-top: 3rem; padding: 2rem; background: var(--color-bg-card); border-radius: 12px; border: 1px solid var(--color-border);">
    ...
    <p style="color: var(--slate-color-400); margin: 0;">
      This is only a partial list of what's planned. The EVO Open Source team welcomes contributors!{" "}<br />
      <a href="https://github.com/evo-code-org/EVO-METHOD" style="color: var(--color-in-progress);">Join us on GitHub</a> to help shape the future of AI-driven development.
    </p>
    <p style="color: var(--slate-color-400); margin: 1.5rem 0 0;">
      Love what we're building? We appreciate both one-time and monthly{" "}<a href="https://buymeacoffee.com/evo" style="color: var(--color-in-progress);">support</a>.
    </p>
    <p style="color: var(--slate-color-400); margin: 1rem 0 0;">
      ...
      <a href="mailto:contact@evocode.com" style="color: var(--color-in-progress);">contact@evocode.com</a>
    </p>
  </div>
</div>
