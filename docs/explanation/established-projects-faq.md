...
description: Common questions about using EVO Method on established projects
sidebar:
  order: 8
---
Quick answers to common questions about working on established projects with the EVO Method (BMM).
...
**Have a question not answered here?** Please [open an issue](https://github.com/evo-code-org/EVO-METHOD/issues) or ask in [Discord](https://discord.gg/gk8jAdXWmj) so we can add it!
